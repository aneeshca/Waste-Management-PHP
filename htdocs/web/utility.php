...
<div class="w3-row">
<div class="w3-half w3-container">
  <img src="images/v3.jpg" style="width:100%">
</div>
<div class="w3-half w3-container">
...
<img src="images/okay.png"  style="border-radius: 50%" alt="Avatar" width="20" height="20">
<a href="remove_staff.php?sl=<?php echo $row['sl'] ?>"> <button type="button" class="btn btn-primary" >remove</button></a><?php echo "</td>"; 
                        echo "</tr>";
